...
ActiveRecord::Schema[8.0].define(version: 2025_08_11_083836) do
  create_table "daily_reports", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["learned_points"], name: "index_daily_reports_on_learned_points", type: :fulltext
    t.index ["user_id", "date"], name: "index_daily_reports_on_user_id_and_date", unique: true
    t.index ["user_id", "is_public"], name: "index_daily_reports_on_user_id_and_is_public"
